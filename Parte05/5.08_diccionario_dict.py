...
print(atributos)
print('Cantidad de llaves (atributos) del diccionario `ccomputador`:', len(atributos))
...
# 3.4.4 popitem(): extrae un elemento (llave, valor) del diccionario siguiendo un esquema LIFO (last in first order):
