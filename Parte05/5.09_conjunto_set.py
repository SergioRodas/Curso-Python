...
print('El tipo de dato de la variable `conjunto_1`:', type(conjunto_1))
print()
print('Contenido de la variable `conjunto_2`:', conjunto_2)
print('Cantidad de elementos del conjunto `conjunto_2`:', len(conjunto_2))
print('El tipo de dato de la variable `conjunto_2`:', type(conjunto_2))
...
print('El tipo de dato de la variable `caracteres`:', type(caracteres))
...
print('¿El color %s se encuentra dentro de los colores de un arcoiris?: %s' % (color, resultado))
...
vacio = set([])
print('Cantidad de elementos del conjunto `vacío`:', len(vacio))
...
# 4.4 Operación de intersección:
print('4.4 Operación de intersección:')
...
# 4.5 Operación de superconjunto:
print('4.5 Operación de superconjunto:')
...
# 4.6 Operación de diferencia de conjuntos: 
print('4.6 Operación de diferencia de conjuntos: ')
...
# 4.7 Operación de diferencia simétrica entre conjuntos:
print('4.7 Operación de diferencia simétrica entre conjuntos:')
...
print('Tipo de dato de la variable `colores`:', type(colores))

# colores.remove('gris') # Genera error KeyError: el color 'gris' no existe en el conjunto `colores`
colores.remove('Gris')
...
print('El color que se removió de la variable `colores` es', color)
