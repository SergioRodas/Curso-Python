...
# Inserción de elemento en una lista por medio de `append()`:
print('Inserción de elemento en una lista por medio de `append()`:')
...
print('Inserción de elemento en una lista por medio de `insert()`:')
...
print('Eliminación de todos los elementos de una lista con el metodo `clear()`:')
print('Cantidad actual de elementos en la lista `numeros`:', len(numeros))
# numeros.clear()
# del numeros[:]
print('Cantidad actual de elementos en la lista `numeros`:', len(numeros))
