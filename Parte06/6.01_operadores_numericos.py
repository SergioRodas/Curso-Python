...
suma = 3.1415 + 2.7172
print(f'La suma de {3.1415} y {2.7172} es igual a {suma}')
...
print(f'La suma de {numero_1} y {2.7172} es igual a {suma}')
...
resta = 5 - 3
print(f'La resta de {5} y {3} es igual a {resta}.')
...
# Resta de valores númericos reales (punto flotante):
print('Resta de valores númericos reales (punto flotante):')
...
print('Resta de valores númericos reales como literales:')

resta = 3.1415 - 2.7172
print(f'La resta de {3.1415} y {2.7172} es igual a {resta}.')

print()

print('Resta de una vaiable númerica real y una literal numérica real:')

resta = numero_1 - 2.7172
print(f'La resta de {numero_1} y {2.7172} es igual a {resta}.')
...
# Operador de producto (multiplicación): *
print('Operador de producto (multiplicación): *')
...
print('Múltiples divisiones en una expresión:')
...
print('Operador resto (residuo, módulo): %')
