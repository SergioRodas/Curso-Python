...
resultado = numero_1 >= numero_2
print('¿{} es mayor o igual que {}?: {}'.format(numero_1, numero_2, resultado))
...
resultado = numero_1 < numero_2
print('¿{} es menor que {}?: {}'.format(numero_1, numero_2, resultado))
...
resultado = numero_1 <= numero_2
print('¿{} es menor o igual que {}?: {}'.format(numero_1, numero_2, resultado))
