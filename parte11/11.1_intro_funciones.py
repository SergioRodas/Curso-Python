...
# 1.1 Creacion de una función:
print('1.1 Creacion de una función:')
...
# 4. Creación de una función para intercambiar los valores de dos variables: 
...
resultado = intercambiar_valores(x, y)
...
print('El resultado de sumar {} y {} es igual a {}.'.format(x, y, suma))
