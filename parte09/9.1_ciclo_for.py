...
# Uso explícito del ciclo for para resolver un problema que requiere iterar (recorrer) todos los elementos de una colección (lista):
...
print('Tipo de dato de la variable `pares`:', type(pares).__name__)
...
print('Tipo de dato de la variable `impares`:', type(impares).__name__)
